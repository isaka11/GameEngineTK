...
public:
	...
	//m_Coin_flagの情報を取得する
	bool Get_Coin() { return m_Coin_flag; }

	//m_Coin_flagの情報を設定する
	void Set_Coin(bool coin) { m_Coin_flag = coin; }

	//m_Delete_flagの情報を取得する
	bool Get_Delete() { return m_Delete_flag; }

	//m_Delete_flagの情報を設定する
	void Set_Delete(bool flag) { m_Delete_flag = flag; }
